...
% de 0.5 produce oscilaciones en la respuesta del sistema, es decir, se aprecian 
% ciclos límites en el sistema. Esto es debido a que la acción de control tiene 
% una magnitud menor a la zona muerta. Estas oscilaciones se pueden corregir subiendo 
% la magnitud de la acción de control para contrarrestar el efecto de la alinealidad 
% del actuador, o buscando un actuador con menor zona muerta.
